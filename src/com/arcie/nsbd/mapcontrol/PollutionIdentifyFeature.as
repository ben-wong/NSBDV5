...
public class PollutionIdentifyFeature
{
    ...
    public function PollutionIdentifyFeature()
    {
    ...
    private function resultFunction(results:Array, token:Object = null):void
    {
        if (results && results.length > 0)
        {
            ...
            if(mainResult.layerName == "污水处理厂" ||mainResult.layerName == "水质监测断面" ){
                var infoWindow:MonitoringWindow = new MonitoringWindow();
                infoWindow.setParams(mainResult.layerName, mainResult.value, mainResult.feature.attributes.CODE);
                PopUpManager.addPopUp(infoWindow, map, true);
